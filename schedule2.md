...
4. **September 21** - [Control Flow](https://datascience.quantecon.org/python_fundamentals/control_flow.html) continued. Net present value stuff (preparation for PS 2). [Functions](https://datascience.quantecon.org/python_fundamentals/functions.html)
5. **September 23** - PS1 review, [Numpy](https://datascience.quantecon.org/scientific/numpy_arrays.html)
